...
import com.etoos.study.player.DownloadTracker;
 ...
 */
public class EtoosApplication extends Application {
	...
	public void onCreate() {
		super.onCreate();
		Thread.setDefaultUncaughtExceptionHandler(new ExceptionHandler("/mnt/sdcard/"));
